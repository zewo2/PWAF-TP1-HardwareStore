...
function App() {
  ...
  <h1 className="text-2xl font-bold" style={{ color: 'var(--bg)' }}>BuildIT</h1>
        ...
        <div className="flex items-center ml-auto">
          <ThemeToggle />
          <Link to="/cart" className="flex items-center px-2 py-2 rounded shadow transition-transform duration-150 hover:scale-95 focus:scale-95" style={{ background: 'var(--card)', color: 'var(--highlight)' }}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="var(--highlight)" viewBox="0 0 24 24" width="24" height="24" className="mr-1">
              <path d="M7 18c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm10 0c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm1.447-2.105l1.553-9.895h-17v2h2l3.6 7.59-1.35 2.44c-.16.28-.25.61-.25.96 0 1.104.896 2 2 2h12v-2h-11.42c-.14 0-.25-.11-.25-.25s.11-.25.25-.25h11.42c.14 0 .25.11.25.25s-.11.25-.25.25h-11.42c-.14 0-.25-.11-.25-.25s.11-.25.25-.25h11.42c.14 0 .25.11.25.25s-.11.25-.25.25h-11.42c-.14 0-.25-.11-.25-.25s.11-.25.25-.25h11.42c.14 0 .25.11.25.25s-.11.25-.25.25h-11.42c-.14 0-.25-.11-.25-.25s.11-.25.25-.25h11.42c.14 0 .25.11.25.25s-.11.25-.25.25h-11.42c-.14 0-.25-.11-.25-.25s.11-.25.25-.25h11.42c.14 0 .25.11.25.25s-.11.25-.25.25h-11.42c-.14 0-.25-.11-.25-.25s.11-.25.25-.25h11.42c.14 0 .25.11.25.25s-.11.25-.25.25z"/>
            </svg>
            <CartCount />
          </Link>
        </div>
